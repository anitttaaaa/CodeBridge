...
public class CandidateExperienceService {
    ...
    @Transactional
    public void createExperienceData(List<CandidateExperienceDTO> candidateExperiencesFromRequest, Authentication authentication) {
        ...
        // Iterujemy przez listę DTO i mapujemy je na encje CandidateExperience
        for (CandidateExperienceDTO experienceDTO : candidateExperiencesFromRequest) {
            CandidateExperience candidateExperience = candidateExperienceMapper.mapToDomain(experienceDTO);
