...
(2, 'Tech University', 'Modern Frontend Frameworks', 'HTML, CSS, JAVA_SCRIPT, REACT', 'A course that covers the latest techniques in frontend development using React, JavaScript, and responsive web design.', '2021-10-01', '2022-06-30'),
(3, 'FullStack Academy', 'Full-Stack Web Development', 'JAVA_SCRIPT, REACT, MICROSERVICES, HTML, CSS, JAVA, PYTHON', 'A comprehensive course on full-stack development, combining frontend, backend, and database technologies.', '2020-03-01', '2021-12-15');
...
values
(1, 'E-commerce Backend System', 'JAVA, SPRING_BOOT, MICROSERVICES, POSTGRESQL', 'Developed a backend system for an e-commerce platform, integrating multiple microservices for payment processing, product management, and order fulfillment.', '2022-03-01', '2022-09-30', 'https://github.com/annanowakk/ecommerce-backend'),
(2, 'Personal Portfolio Website', 'HTML, CSS, JAVA_SCRIPT, REACT', 'Created a personal portfolio website to showcase frontend development skills, including interactive UI elements and a blog section.', '2021-05-01', '2021-08-31', 'https://github.com/adamkowalskii/portfolio'),
(3, 'Task Management Web App', 'JAVA_SCRIPT, REACT', 'Built a task management web app allowing users to create, update, and track tasks in real-time with authentication and user roles.', '2020-01-01', '2020-12-31', 'https://github.com/katarzynamatejkoo/task-manager');
